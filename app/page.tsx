  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#06101f] px-6 pb-20 pt-48 text-white font-sans">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        {/* 🏟️ UPCOMING MATCHES SECTION (원래 모양 유지 + 크기 확대) */}
        <div className="mb-24 relative z-0 space-y-20">
          <p className="mb-6 text-[11px] font-black tracking-[0.5em] text-cyan-400/50 uppercase italic">Upcoming Matches / Live Event</p>

          {/* 🏟️ 1. 남자축구 경기 (원래 모양 유지 + 크기 확대) */}
          {/* 💡 rounded-[60px]와 aspect-[21/9] 비율을 유지하면서 화면에 꽉 차게 확대 */}
          <div className="relative overflow-hidden rounded-[60px] border border-white/5 bg-black/40 shadow-[0_40px_100px_rgba(0,0,0,0.6)] group aspect-[21/9] w-full max-w-7xl mx-auto">
            ...
            <div className="relative z-10 h-full w-full">
              {/* 왼쪽 팀 (빵빵이 - 크기 확대) */}
              {/* 💡 w-[65%]로 로고 크기를 대폭 키워 압도감 조성 */}
              <div className="absolute left-1/4 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[65%] aspect-square flex items-center justify-center">
                <Link href={`/masl/26s/team/${encodeURIComponent("빵빵이의 축구교실")}`} className="block w-full h-full transition-all duration-500 hover:scale-105 active:scale-95">
                  <img 
                    ...
                    className="w-full h-full object-contain filter brightness-110 drop-shadow-[0_0_50px_rgba(255,255,255,0.15)] group-hover:drop-shadow-[0_0_100px_rgba(34,211,238,0.5)] transition-all" 
                    alt="Team Left" 
                  />
                </Link>
              </div>
        ...
        {/* 🏆 TOURNAMENT BRACKET (원래 모양 유지 + 크기 확대) */}
