  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#06101f] px-6 pb-20 pt-48 text-white font-sans">
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        ...
        {/* 🚀 HEADER SECTION (타이틀 디자인 및 텍스트 수정) */}
        <div className="mb-24 animate-in fade-in slide-in-from-top-6 duration-700">
          <div className="inline-flex rounded-full border border-cyan-400/20 bg-cyan-400/10 px-5 py-2 text-[10px] font-black uppercase tracking-[0.4em] text-cyan-300 shadow-[0_0_15px_rgba(34,211,238,0.2)]">
          ...
          <div className="mt-8">
            <h1 className="text-6xl md:text-[8rem] font-black italic tracking-[-0.04em] leading-[0.9] uppercase">
              <span className="text-white block opacity-95">SPORTS</span>
            ...
            <div className="mt-10 h-[5px] w-32 bg-gradient-to-r from-cyan-400 to-lime-400 shadow-[0_0_30px_rgba(34,211,238,0.8)] rounded-full" />
          </div>
        </div>
